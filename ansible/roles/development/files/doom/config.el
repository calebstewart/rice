...
(setq user-full-name "Caleb Stewart"
      user-mail-address "caleb.stewart94@gmail.com")
...
;; Pop-up editors have never worked right for me
...
(after! org
        (setq org-agenda-files '("~/git/org/agenda")))

;; Setup Javascript editing
(setq js-indent-level 2)

;; Setup C++ and platformio
...
;; Custom function used to update the poetry environment
(defun custom-reload-venv ()
  ...
  ; Re-deduce our project directory and venv
  (poetry-venv-workon)
...
; Disable LSP links,  because they break treemacs
